...
no_of_letters = int(input("How many letters would you like in your password? "))      #casting the string into integer
...
for character in final_password_list:
    ...
    string_pasword.append(character)

# Print the string password
print("your password is: ")
print("".join(string_pasword))
